      ...
      <div class="sm:flex sm:items-center px-6 py-4">
        ...
        <div class="text-center sm:text-left sm:flex-grow">
          ...
          <div class="flex flex-wrap">
            <button class="text-xs font-semibold rounded-full px-4 py-1 mx-3  leading-normal bg-white border border-blue text-blue hover:bg-blue-600 hover:text-white">Call</button>
            <button class="text-xs font-semibold rounded-full px-4 py-1 leading-normal bg-white border border-purple text-purple hover:bg-purple-600 hover:text-white">Message</button>
          </div>
        </div>
      </div>
    </div>
